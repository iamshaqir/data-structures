...
/**
 * There are n cities. Some of them are connected, while some are not. If city aset is connected directly with city b,
 * and city b is connected directly with city c, then city aset is connected indirectly with city c.
 * <p>
 * A province is aset group of directly or indirectly connected cities and no other cities outside of the group.
 * <p>
